...
class UIElement {
	public:
		...
		void setGlobalPosition(enum ElementPosition position, sf::Sprite& sprite, sf::Vector2f margins = { 0.f,0.f });
		...
		virtual void setSortIndex(uint8_t new_depth) = 0;
		virtual uint8_t getSortIndex() const = 0;
